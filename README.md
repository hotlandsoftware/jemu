...
JEMU is still in an alpha state. It will likely never be "complete" as there will always be more machines and hardware for it to emulate. Currently the absolute latest (for my end) is set to 1985 (exceptions made for clone consoles), and will be increased as more machines are completed/added.
